...
/*   Updated: 2020/05/30 02:41:05 by smaccary         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
** You can add any test you want using the "printer" function pointer as printf
*/
...
int main(int argc, char **argv)
{
	...
	habitant morbi tristique senectus et netus et males%iuada fames ac turpis egestas. Phasellus tristique lobortis leo. Maecenas bibendum\
	pulvinar diam ac fermentum. Integer vel mauris vitae nisl maximus porta. Nunc a eros quam. Etiam finibus ante non purus imperdiet consectetur.\
		...
		at placerat. Vestibulum nec tincid%sunt quam.";
	int (*printer)(char *, ...);
